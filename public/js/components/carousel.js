...
export default class Carousel extends HTMLElement {
  ...
  constructor() {
    ...
    this.shadow.appendChild(carouselTemplate.content);
	this.container = this.shadow.querySelector('.slide-track');
	this.setupCarousel();
  }
  ...
  connectedCallback() {
	...
	// let categoryItems = this.container.querySelectorAll('.category-item');
  ...
  carouselItemTemplate = (item) => `
    ...
    <a class="category-item" data-category="${item.id}">
