...
<tr class="cart-item" id="id${product.id}">
    <td class="py-3 align-middle" scope="row">
      <a class="reset-anchor d-block" href="detail.html">
        <img src="${product.image}" alt="${product.name}" height="30"></a>
    </td>
    <td class="py-3 align-middle" scope="row">
      <a class="reset-anchor d-block" href="detail.html">${product.name}</a>
    </td>
    <td  class="py-3 align-middle" scope="row"><span class="mb-0 small">$<span class="product-price">${product.price}</span></span></td>
    <td  class="py-3 align-middle qty" scope="row">
    ...
    <td class="py-3 align-middle" scope="row"><span class="mb-0 small">$<span class="product-subtotal">0</span></span></td>
